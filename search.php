...
<body>
<h1>Register here!</h1>
<p>Type the Name or Email or Company then click <strong>Search</strong> to search.</p>
<form method="get" action="search.php" enctype="multipart/form-data" >
      
      Search by Name :<input type="text" name="name" id="searchname"/></br>
      Search by E-mail :<input type="text" name="email" id="searchemail"/></br>
      Search by Company :<input type="text" name="company" id="searchcompany"/></br></br>
